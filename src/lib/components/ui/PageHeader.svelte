<script lang="ts">
	...
	let { title, description, backHref, backLabel = 'Wróć' }: Props = $props();
</script>

<header
	class="mb-8 flex flex-col gap-4 border-b border-zinc-200 pb-6 sm:flex-row sm:items-start sm:justify-between"
>
	<div>
